...
const { buildReadMorePage } = require("./build.js");
...
app.post("/admin/createreadmore", (req, res) => {

  const { filename, page, yaml } = req.body;
  ...
  buildReadMorePage(filename);

  res.send("Read More page created");
